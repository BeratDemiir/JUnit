...
public class C00_ExtentReports_Interview {
...
Extent Tess
Bu sınıflar yardımıyla, platform, browser, environment, tester, takim bilgileri gibi özel proje bilgileri ekleyebilirim. Ayrıca extent test
